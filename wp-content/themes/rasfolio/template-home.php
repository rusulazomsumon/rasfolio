...
<?php /* Template Name: Home Page */ ?>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Rusul Azom Sumon</h1>
      <p>I'm <span class="typed" data-typed-items="Wordpress Developer, Content Creator, Freelancer, Laravel Developer"></span></p>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-12 icon-box" data-aos="fade-up">
            <div class="thumnail">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/profile-img.jpg" height="300px" width="300px" alt="blog-thumbnail">
            </div>
